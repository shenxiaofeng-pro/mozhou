...
> 计划状态：已批准，范围冻结  
> 开始日期：2026-08-09  
> 当前阶段：M1 创作可信度与核心可达性热修
> 总体状态：M0 已按产品负责人确认的免费私有仓库例外完成；M1 已完成事实选择与窄窗 AI 可达性两项切片，尚未达到总体 Definition of Done
...
| M1 创作可信度与核心可达性热修 | 进行中 | 51+ 条事实回归、窄窗 AI 导演入口、工作区摘要与章节正文按需读取已通过 |
| M2 可恢复 AI 任务运行时 | 未开始 | — |
| M3 模型网关、密钥与用量治理 | 未开始 | — |
| M4 长篇上下文编译器 | 未开始 | — |
| M5 全局拆书库与现实资料导入 | 未开始 | — |
...
- 为桌面 sidecar 增加每次启动的随机会话令牌，并验证缺失、错误和正确令牌三类请求。
