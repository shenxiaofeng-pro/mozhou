...
> 计划状态：已批准，范围冻结  
> 开始日期：2026-08-09  
> 当前阶段：M5 全局拆书库与现实资料导入
> 总体状态：M0、M1、M2、M3、M4 已完成本地验收；M4 待远端 PR 门收口；尚未达到总体 Definition of Done
...
- M4 功能、长篇黄金集、完整工程检查与真实浏览器验收已通过；推送 PR 并通过 macOS、Windows 和 security 远端门后开始 M5。
