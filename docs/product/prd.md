...
1. 首要用户是持续更新中文男频网文的个人作者；正式支持历史重生、都市重生、东方玄幻和西方奇幻，其他传统类型小说与文学小说作为后续扩展方向。
...
东方玄幻和西方奇幻则要求系统把力量来源、等级边界、突破或施法代价、资源循环、宗门/种族/阵营关系和世界纪年作为硬约束。若仍套用重生题材的现实时间线，AI 会无依据加入前世记忆；若不追踪力量成本，又会产生境界漂移、魔法万能和势力行为失真。
...
1. 作者从创意或已有稿件创建项目。
2. 资料研究员把作者导入的史料、新闻、行业资料、地理信息、神话资料、世界设定和个人笔记整理为带时间、来源与可信度的资料卡。
...
5. 总导演协助形成目标读者、核心卖点、故事引爆/重生分歧点、长期承诺、人物弧、资源成长线、卷级方向和滚动章纲。
6. 双轨时间线模块区分现实/世界底稿、小说演变和角色知识；重生题材追踪未来知识失效，幻想题材追踪预言、推演和规则变化。
7. 上下文编译器根据当前章节精准选择人物状态、力量/魔法规则、现实或设定资料、时间线、伏笔、历史摘要和文风维度。
...
- 支持现实/世界底稿、小说时间线、故事引爆/重生分歧点和角色知识账本，防止变化后仍照搬旧历史或突破既定世界规则。
- 支持作者导入现实或世界设定资料并形成可引用资料卡；AI 必须区分有来源事实、作者设定和推演假设。
...
- 世界机制评测：固定玄幻/奇幻测试集中，境界越级、力量来源不明、代价缺失、魔法规则和阵营约束冲突的召回率达到 90%。
...
- **东方玄幻作者（核心）**：需要稳定的修炼体系、境界边界、力量代价、资源循环和宗门势力因果。
- **西方奇幻作者（核心）**：需要自洽的魔法规则、种族/阵营关系、地域文化、资源成本和多线势力推进。
...
63. 作为重生作者，我想建立重生年代、地点、关键历史节点和未来知识边界，以便确定故事的现实基线。
64. 作为玄幻/奇幻作者，我想建立故事纪年、起始地域、力量规则、升级代价和势力关系，以便避免世界机制随剧情漂移。
...
| 模块 | P0 MVP | P1 | P2 |
|---|---|---|---|
| 项目、卷章树、编辑器 | 四题材创建、编辑、自动保存、连载看板 | 分支、批量操作 | 多窗口 |
| 导入 | TXT、Markdown、PDF | DOCX、网页资料卡 | Scrivener 等格式 |
| 规划 | 卖点、四题材模板、卷级方向、滚动章纲、场景、钩子与兑现 | 专用力量体系编辑器、节奏曲线 | 可视化关系图 |
| 故事事实库 | 人物、世界、基线/小说双轨、角色知识、伏笔、来源 | 知识边界、影响分析 | 系列级共享设定 |
| 资料研究 | 本地资料卡、纪年、来源、可信度、事实/设定分层 | 网页采集与来源更新 | 共享题材资料包 |
...
- 题材机制看板：重生题材显示原始/小说时间线与未来知识；幻想题材显示世界底稿/小说演变、先验知识和待核实规则资料。
...
- 东方玄幻与西方奇幻固定项目均能识别力量/魔法规则、代价、资源和势力约束冲突，且不得无依据加入重生设定。
...
10. 东方修炼体系和西方魔法体系是否需要独立结构化编辑器；当前版本通过蓝图、资料卡、正式事实与审校规则表达，专用编辑器作为后续增强评估。
